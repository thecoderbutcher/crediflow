...
const ListLoanCustomer = () => {
  return (
    <div className='flex flex-col gap-4 mt-2'>
        <Link href={'/admin/loans/quotas'} className='flex gap-2 items-center justify-between px-4 py-2 bg-white mx-2 rounded-lg shadow-md border-l-4 border-l-danger'> 
